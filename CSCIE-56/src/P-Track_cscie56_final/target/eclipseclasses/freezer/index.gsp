		...
		<div id="list-freezer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="name" title="${message(code: 'freezer.name.label', default: 'Name')}" />
					
						<g:sortableColumn property="rackspershelf" title="${message(code: 'freezer.rackspershelf.label', default: 'Rackspershelf')}" />
					
						<g:sortableColumn property="shelves" title="${message(code: 'freezer.shelves.label', default: 'Shelves')}" />
				...
				<g:each in="${freezerInstanceList}" status="i" var="freezerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: freezerInstance, field: "rackspershelf")}</td>
					
						<td>${fieldValue(bean: freezerInstance, field: "shelves")}</td>
