		...
		<div id="list-post" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="post.photos.label" default="Photos" /></th>
					
						<g:sortableColumn property="posted" title="${message(code: 'post.posted.label', default: 'Posted')}" />
				...
				<g:each in="${postInstanceList}" status="i" var="postInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: postInstance, field: "photos")}</td>
					
						<td><g:formatDate date="${postInstance.posted}" /></td>
